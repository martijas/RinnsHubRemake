...
local itemSpots = {
    ...
    Sundial_Totem = CFrame.new(-1145.18762, 134.499985, -1071.91455, 0.929291666, -1.01531432e-08, -0.369346708, 2.94604785e-09, 1, -2.00770867e-08, 0.369346708, 1.75693557e-08, 0.929291666),
    Aurora_Totem = CFrame.new(-1809.44043, -136.927933, -3283.50488, -0.694645286, -3.32417849e-09, 0.719352424, 7.47273132e-10, 1, 5.34267786e-09, -0.719352424, 4.24881863e-09, -0.694645286)
}
                        ...
                        if child.Visible == true then
                            ...
                            elseif autoShakeMethod == "KeyCodeEvent" then
                                while RenderStepped:Wait() do
                                    if autoShake and safezone:FindFirstChild(child.Name) ~= nil then
...
local LightingGroup = Tabs.Main:AddRightGroupbox('Lighting')

local LightingToggleButton = LightingGroup:AddButton({
    ...
    Func = function()
        ...
        elseif LightingStatus == false then
            for __, vv in pairs(game.Lighting:GetDescendants()) do
                if vv:GetAttribute("NeedsToBeEnabled") == true then
                    vv.Enabled = true
                end
            end
        end
    ...
    DoubleClick = false,
    Tooltip = 'Toggles Lighting On/Off, making the game more visible'
})
